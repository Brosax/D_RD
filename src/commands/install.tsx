  ...
  useEffect(() => {
    if (state.type === 'success') {
      ...
      setTimeout(
        onDone,
        2000,
        'Dekra CLI installation completed successfully',
        {
      ...
      setTimeout(onDone, 3000, 'Dekra CLI installation failed', {
        display: 'system' as const,
      })
    }
  }, [state, onDone])
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      {state.type === 'installing' && (
        <Text color="claude">
          Installing Dekra CLI native build {state.version}...
        </Text>
      )}
        ...
        <Box flexDirection="column" gap={1}>
          <Box>
            ...
            <Text color="success" bold>
              Dekra CLI successfully installed!
            </Text>
          </Box>
...
export const install = {
  ...
  name: 'install',
  description: 'Install Dekra CLI native build',
