...
减少常见 LLM 编码错误的准则，源自 Andrej Karpathy 的观察：

**Tradeoff:** 这些准则偏向谨慎而非速度。对于简单任务可自行判断。
...
- 不添加未被要求的"灵活性"或"可配置性"。
- 不处理不可能发生的场景的错误。
- 如果能 50 行解决而你写了 200 行，重写。

自问："高级工程师会说这太复杂吗？"如果是的，简化。
...
强的成功标准让你能独立循环。弱的标准（"让它工作"）需要不断确认。
